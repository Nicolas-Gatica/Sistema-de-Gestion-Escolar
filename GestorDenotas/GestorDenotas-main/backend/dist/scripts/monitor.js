...
async function displaySystemStatus() {
    ...
    try {
        ...
        const metrics = await (0, monitoring_1.getSystemMetrics)();
        const health = await (0, monitoring_1.isSystemHealthy)();
        const availability = (0, monitoring_1.calculateAvailability)(24);
        // Estado general
        ...
        const backupStats = backupService_1.backupService.getBackupStats();
        console.log('💾 BACKUPS:');
